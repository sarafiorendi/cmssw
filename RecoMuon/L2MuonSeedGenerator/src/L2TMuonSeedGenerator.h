#ifndef RecoMuon_L2TMuonSeedGenerator_L2TMuonSeedGenerator_H
#define RecoMuon_L2TMuonSeedGenerator_L2TMuonSeedGenerator_H
...
// Data Formats 
#include "DataFormats/MuonSeed/interface/L2TMuonTrajectorySeed.h"
#include "DataFormats/MuonSeed/interface/L2TMuonTrajectorySeedCollection.h"
...
class L2TMuonSeedGenerator : public edm::stream::EDProducer<> {
 
 public:
  
  /// Constructor
  explicit L2TMuonSeedGenerator(const edm::ParameterSet&);

  /// Destructor
  ~L2TMuonSeedGenerator();
